      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            ...
            <span className="font-bold text-xl hidden sm:block bg-gradient-to-r from-slate-900 to-slate-600 dark:from-white dark:to-slate-300 bg-clip-text text-transparent">
              Creative Vault
            </span>
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-6 flex-1 max-w-3xl mx-8">
            ...
            <div className="flex items-center space-x-2">
              <Button
                ...
                className="rounded-full h-9 px-4 font-medium transition-all duration-300 hover:scale-105"
              >
                All
              </Button>
              {popularTags.map((tag) => (
                <Badge
                  ...
                  className="cursor-pointer hover:scale-105 transition-all duration-300 rounded-full px-3 py-1.5 font-medium shadow-sm hover:shadow-md"
            ...
            <div className="flex flex-wrap gap-2 mt-6">
              ...
              {popularTags.map((tag) => (
                <Badge
                  key={tag}
                  variant={selectedTag === tag ? "default" : "secondary"}
                  className="cursor-pointer transition-all duration-300 rounded-full px-3 py-1.5"
                  onClick={() => onTagSelect(selectedTag === tag ? null : tag)}
                >
                  #{tag}
                </Badge>
